...
| [web-dashboard.md](web-dashboard.md) | The browser dashboard: what it shows, how it works, live parameter tuning, measuring distances on the map, and clearing or deleting a map. Safe to run alongside anything. |
