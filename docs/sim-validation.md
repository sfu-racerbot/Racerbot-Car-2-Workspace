...
**Real:** F1TENTH Gym single-track dynamics with RK4 at 5 ms, multi-car ray-cast LiDAR, 1081 beams over 270° matching the Hokuyo UST-10LX, the 0.26 m LiDAR offset, the padded 0.58 × 0.31 m body, 40 Hz control, and the real ROS graph above the drivers.
